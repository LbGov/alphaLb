...
data=data+'<h2> ساعدنا على تحسين GOV.LB</h2><label for="Form_FeedbackForm_Doing">ماذا كنت تفعل</label><input type="text" name="doingAction" class="dg_input_form_ar" id="Form_FeedbackForm_Doing" required="required" />';

data=data+'<label for="Form_FeedbackForm_Wrong">ماذا حصل</label><input type="text" name="wrongAction" class="dg_input_form_ar" id="Form_FeedbackForm_Wrong" required="required" />';
