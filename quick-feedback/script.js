...
data = data + '<input type="hidden" name="Referer" value="http://portal.gov.lb/index.html" class="hidden" id="Form_FeedbackForm_Referer" />&nbsp;<div><input type="submit"  style="  width: 10em;  " name="action_doProcessProblem" value="Submit" />';
