    ...
    if (state == "open") {
        ...
        if (state == "secure") {
            ...
            for (i = 1; i < judgments.length; i++) {
                ...
                judgment_data = judgment_data + "<label style='position:absolute;left:40px'>" + judgments[i].split("date_judgment>")[1].split("<")[0] + "</label>";
                judgment_data = judgment_data + "<label style ='position:absolute;left:317px'>" + judgments[i].split("court>")[1].split("<")[0] + "</label>";
                judgment_data = judgment_data + "<label  style='position:absolute;left:550px'>" + judgments[i].split("type_offence>")[1].split("<")[0] + "-" + judgments[i].split("time_punishment>")[1].split("<")[0] + "</label></br>";
